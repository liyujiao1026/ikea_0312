...
#==========================================================================#
# Run all of analysis
result <- Func_paper(invYear = invYear ,treat_ID = treat_ID , clusterNumber = clusterNumber , predictors = predictors, data_firm = data_firm )


setwd("./Empirical_study_0312/Empirical_results")
...
saveRDS(fitting_CI, paste0("./Empirical_study_0303/Empirical_results/Bootstrap_NonPar_CI_", treat_ID))

fitting_CI_haparanda <- readRDS("./Empirical_study_0303/Empirical_results/Bootstrap_NonPar_CI_2583")
