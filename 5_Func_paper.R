...
Func_paper <- function(invYear,treat_ID , clusterNumber, predictors, data_firm){
            ...
            saveRDS(Donor_ID, paste0("./Empirical_study_0312/Empirical_results/Donor_",treat_ID))
            ...
            saveRDS(result_SCM, paste0("./Empirical_study_0312/Empirical_results/SCM_",treat_ID))
            ...
            saveRDS(result_placebo, paste0("./Empirical_study_0312/Empirical_results/Placebo_",treat_ID))
            ...
            saveRDS(result_bootstrap_NonPar, paste0("./Empirical_study_0312/Empirical_results/Bootstrap_NonPar_",treat_ID))
            
            
            boot1 <- lapply(result_bootstrap_NonPar, function(x){x[6]})
            boot_2 <- boot1[[1]]$Y.sc
            for (i in 2:500){
                        boot_2 <- cbind(boot_2, as.numeric(boot1[[i]][[1]] ))
            }
            
            SC_bootstrap_NonPar <- boot_2
            saveRDS(SC_bootstrap_NonPar, paste0("./Empirical_study_0312/Empirical_results/Bootstrap_NonPar_SC_",treat_ID))
            ...
            saveRDS(result_bootstrap_par, paste0("./Empirical_study_0312/Empirical_results/Bootstrap_Par_",treat_ID))
            
            #===========================================================#
            return(list("Donor_ID" = Donor_ID,
                        "result_SCM" = result_SCM, "weight_paper" = weight_paper, 
                        "result_placebo" = result_placebo,
                        "result_bootstrap_NonPar" = result_bootstrap_NonPar, "SC_bootstrap_NonPar" = SC_bootstrap_NonPar,
